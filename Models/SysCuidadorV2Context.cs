...
public partial class SysCuidadorV2Context : DbContext
{
    public SysCuidadorV2Context()
    {
    }

    public SysCuidadorV2Context(DbContextOptions<SysCuidadorV2Context> options)
        : base(options)
    {
    }
